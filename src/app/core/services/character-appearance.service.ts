...
export class CharacterAppearanceService {
  ...
  createForActionBeat(productionId: number, data: { character_id: number; action_beat_id: number }): Observable<CharacterAppearance> {
    return this.http.post<CharacterAppearance>(`${this.apiUrl}/${productionId}/character_appearances/for_action_beat`, data);
  }
